...
@Component({
  selector: 'app-cqpattern4',
  templateUrl: './cqpattern4.component.html',
  styleUrls: ['./cqpattern4.component.scss']
})
export class CQPattern4Component implements OnInit {
  CE1:Array<Object> = [];  
  CE2:Array<Object> = [];
  ...
  onSubmit() { 
this.dataService.getCQCounter(4).subscribe((data:any) => {this.existing_cq_instances = data;});
setTimeout(() => {
  this.tableRows.push({
  DD1: this.DD1_sel,
  DD2: this.DD2_sel,
  DD3: this.DD3_sel})
  this.dataService.insert_data_CQ4(this.DD1_sel,this.DD2_sel,this.DD3_sel,(this.existing_cq_instances.length) + 1,this.add_as_class1, this.add_as_op, this.add_as_class2).subscribe(data => {data});
  this.DD1_sel="", 
  this.DD2_sel="",
  this.DD3_sel="",
  this.DD1_sel_Info="",
